...
export default function MonthlyRecordsListView({ data, categories, expandedDates, onToggleDate }: Props) {
  return (
    <div className="space-y-4">
      {data.length === 0 && (
        <div className="text-center text-muted-foreground py-8">기록이 없습니다</div>
      )}
      {data.map((day) => {

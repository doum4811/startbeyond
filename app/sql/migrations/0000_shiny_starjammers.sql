...
CREATE UNIQUE INDEX "user_default_pref_profile_code_idx" ON "user_default_code_preferences" USING btree ("profile_id" text_ops,"default_category_code" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "stats_cache_profile_month_idx" ON "stats_cache" USING btree ("profile_id" text_ops,"month_date" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "monthly_reflections_profile_month_idx" ON "monthly_reflections" USING btree ("profile_id" date_ops,"month_date" date_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "shared_links_profile_page_period_idx" ON "shared_links" USING btree ("profile_id" uuid_ops,"page_type" text_ops,"period" uuid_ops);--> statement-breakpoint
CREATE POLICY "community_posts_rls" ON "community_posts" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "Allow all users to read community posts" ON "community_posts" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "community_comments_rls" ON "community_comments" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "daily_notes_rls" ON "daily_notes" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "daily_records_rls" ON "daily_records" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "memos_rls" ON "memos" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "user_default_code_preferences_rls" ON "user_default_code_preferences" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "conversations_rls" ON "conversations" AS PERMISSIVE FOR ALL TO "authenticated" USING (((auth.uid() = participant1_id) OR (auth.uid() = participant2_id))) WITH CHECK (((auth.uid() = participant1_id) OR (auth.uid() = participant2_id)));--> statement-breakpoint
CREATE POLICY "stats_cache_rls" ON "stats_cache" AS PERMISSIVE FOR ALL TO public USING ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "messages_rls" ON "messages" AS PERMISSIVE FOR ALL TO "authenticated" USING (((auth.uid() = sender_id) OR ( SELECT true
   FROM conversations c
  WHERE ((c.id = messages.conversation_id) AND ((c.participant1_id = auth.uid()) OR (c.participant2_id = auth.uid())))))) WITH CHECK (((auth.uid() = sender_id) AND ( SELECT true
   FROM conversations c
  WHERE ((c.id = messages.conversation_id) AND ((c.participant1_id = auth.uid()) OR (c.participant2_id = auth.uid()))))));--> statement-breakpoint
CREATE POLICY "daily_plans_rls" ON "daily_plans" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "monthly_goals_rls" ON "monthly_goals" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "monthly_reflections_rls" ON "monthly_reflections" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "weekly_notes_rls" ON "weekly_notes" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "weekly_tasks_rls" ON "weekly_tasks" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "user_code_settings_rls" ON "user_code_settings" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "user_subcodes_rls" ON "user_subcodes" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "user_categories_rls" ON "user_categories" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = profile_id)) WITH CHECK ((auth.uid() = profile_id));--> statement-breakpoint
CREATE POLICY "notifications_rls" ON "notifications" AS PERMISSIVE FOR ALL TO "authenticated" USING ((auth.uid() = recipient_id)) WITH CHECK ((auth.uid() = recipient_id));
*/